...
const tools = [
  ...
  },
  {
    ...
    items: [
      {
        name: 'LifeLock',
        tagline: 'Best-in-class identity theft protection and recovery',
        description: "LifeLock monitors your personal info across credit bureaus, the dark web, and public records. If your identity is stolen, their recovery specialists handle the process — including reimbursing stolen funds up to your plan limit. Backed by a million-dollar protection guarantee.",
        url: 'https://lifelock.com',
        badge: 'Best Identity Protection',
        badgeColor: '#8b5cf6',
        sponsored: true,
        features: ['Dark web monitoring', 'Credit bureau alerts', 'Identity theft insurance', 'Dedicated recovery specialists', 'Million-dollar protection guarantee'],
      },
    ],
  },
];
