...
const checklist = [
  ...
  const itemListSchema = {
    ...
    "itemListElement": checklist.map((item, index) => ({
      "@type": "ListItem",
      "position": index + 1,
      "name": item.title,
...
export default function PasswordSafetyChecklistPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(itemListSchema) }} />
