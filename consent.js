/* consent.js — lightweight Consent Mode v2 banner (non-TCF)
   For EEA/UK you’ll eventually want a TCF v2–certified CMP (e.g., Funding Choices).
   When you enable a CMP, remove this file and its <script> include on pages.
*/
(function () {
  // Consent defaults: denied until user chooses
  ...
  msg.innerHTML='We use cookies to help show relevant ads and measure performance. You can accept or reject. See our <a href="/privacy.html" style="color:#81e6d9">Privacy Policy</a>.';
